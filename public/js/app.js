...
imgButtom.addEventListener('click', function () {
  ...
  if (document.querySelector('.block-error')) {
    var blockError = document.querySelector('.block-error');
